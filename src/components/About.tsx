...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-[#F4F1EA] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/5] lg:aspect-square">
              ...
              <div className="absolute bottom-10 left-10 right-10 text-white">
                <p className="font-display font-bold text-4xl mb-2 uppercase tracking-wide">{t('about.smokySpicy')}</p>
                <p className="text-gray-300 font-medium">{t('about.marinated')}</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-6 text-lg text-gray-600 mb-10 font-medium leading-relaxed">
              <p>
